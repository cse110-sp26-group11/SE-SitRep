...
test.describe('API Tests', () => {
  ...
  test('standup create and update round-trip through the backend', async ({ request }, testInfo) => {
  ...
  test('availability updates persist for a unique test week', async ({ request }, testInfo) => {
    expect(request).toBeTruthy()
