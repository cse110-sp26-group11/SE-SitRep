 ...
 * @param {string} isoDate - ISO timestamp to expose as the current time.
 * @returns {Promise<void>}
 */
 ...
 * @param {import('@playwright/test').Page} page - Browser page.
 * @param {string} [path] - App path to visit.
 * @returns {Promise<void>}
 */
 ...
 * @param {import('@playwright/test').Page} page - Browser page.
 * @param {string} viewName - View id to activate.
 * @returns {Promise<void>}
 */
 ...
 * @param {import('@playwright/test').Page} page - Browser page.
 * @param {string} userId - Demo user id to select.
 * @returns {Promise<void>}
 */
 ...
 * @param {import('@playwright/test').TestInfo} testInfo - Current Playwright test metadata.
 * @returns {string} Unique ISO date.
 */
 ...
 * @param {import('@playwright/test').TestInfo} testInfo - Current Playwright test metadata.
 * @returns {string} Unique Monday ISO date.
 */
 ...
 * @param {import('@playwright/test').Page} page - Browser page.
 * @param {string} endpoint - API endpoint substring.
 ...
 * @param {{userId?: string}} requestOptions - Optional authenticated user override.
